...
@RestController
@RequestMapping(value = "/type-level-annotation-api", produces = {MediaType.APPLICATION_JSON_VALUE})
@Api(value = "/type-level-annotation-api", produces = MediaType.APPLICATION_JSON_VALUE)
@ApiResponses({
...
public class TypeLevelAnnotationApi {
